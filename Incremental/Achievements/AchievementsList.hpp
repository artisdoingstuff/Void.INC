...
inline void achievementsList()
{
    ...
    achievements.push_back({ "Ooo Shiny!", "Click on 1 Buff", AchievementType::BuffTriggered, 1 });
    achievements.push_back({ "Shiny Bubble!", "Click on 10 Buffs", AchievementType::BuffTriggered, 10 });
    achievements.push_back({ "Have you seen a Duck?", "Click on 25 Buffs", AchievementType::BuffTriggered, 25 });
    achievements.push_back({ "Go for Gold!", "Click on 50 Buffs", AchievementType::BuffTriggered, 50 });
    achievements.push_back({ "Drowning in Bubbles", "Click on 75 Buffs", AchievementType::BuffTriggered, 75 });
    achievements.push_back({ "Apparently Chaos occurs...", "Click on 100 Buffs", AchievementType::BuffTriggered, 100 });
    achievements.push_back({ "Reach for the Stars!", "Click on 250 Buffs", AchievementType::BuffTriggered, 250 });
    ...
    achievements.push_back({ "The Creator", "", AchievementType::BuffTriggered, 219.0, "", false, true  });
}