...
inline vector<GlobalBuffVariant> globalBuffVariants = {
    ...
    { GlobalBuffType::Multiplicative, 4.0f, 20.0f,  8.0f, &goldenBubbleTexture, buffVariantType::globalBubbleBuff },
    { GlobalBuffType::Additive,       1.0f,  0.0f, 20.0f, &goldenBubbleTexture, buffVariantType::globalBubbleBuff },
    { GlobalBuffType::Chaos,          0.6f, 14.0f,  1.0f, &goldenBubbleTexture, buffVariantType::globalBubbleBuff },
    { GlobalBuffType::Frenzy,         1.5f, 20.0f,  3.0f, &goldenBubbleTexture, buffVariantType::globalBubbleBuff },
    { GlobalBuffType::Mayhem,         0.9f, 20.0f,  2.0f, &goldenBubbleTexture, buffVariantType::globalBubbleBuff },
    { GlobalBuffType::Mutated,        1.0f, 30.0f,  2.0f, &goldenBubbleTexture, buffVariantType::globalBubbleBuff },
...
inline void queueGlobalBuffs(int count)
{
    ...
    baseDelay *= globalBuffSpawnDelayMultiplier * getWeatherSpawnRateMultiplier(currentWeather.current);
